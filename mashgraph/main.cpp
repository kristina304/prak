...
int main()
{
   ...
   // unsigned int briksnormTexture = loadTexture("NormalMap.png");
   ...
   /* vector<glm::vec3> windows
    ...
    while (!glfwWindowShouldClose(window))
    {
      ...
      /*  // sort the transparent windows before rendering
        ...
        //матрица ортографической проекции, для того чтобы направленный свет не исказил перспективу
        lightProjection = glm::ortho(-10.0f, 10.0f, -10.0f, 10.0f, near_plane, far_plane);
        //матрица вида для преобразования
